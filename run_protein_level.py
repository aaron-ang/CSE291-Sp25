...
def analyze_drug(drug, df, intensities, protein, output_dir, min_samples=30):
    ...
    drug_cols = [col for col in cols if drug in col and 'nM' in col][:5]  # Still limit to 5 concentrations
    ...
    sns.kdeplot(data=intensities, label=f'Overall Distribution (n={len(intensities)})', 
    ...
    plt.title(f'Distribution Comparison for {protein} - {drug}\n'
    ...
    # Save plot
    plt.savefig(os.path.join(output_dir, f'distro_comparison_{drug}.png'), dpi=300, bbox_inches='tight')
    plt.close()
...
if __name__ == "__main__":
    ...
    drugs = [
        "AEE-788", "AEE-788_inBT474", "AEW-541", "AMG-208", "AMG-208_withCAKI",
        "AMG-900", "ARRY-380", "ARRY-380_inBT474", "ASP-3026", "AT-13148",
        "AT-7519", "AT-9283", "AV-412", "AV-412_inBT474", "AXL-1717",
        "AZD-1208", "AZD-1480", "AZD-2014", "AZD-4547", "AZD-5363",
        "AZD-5438", "AZD-6482", "AZD-7762", "AZD-8055", "AZD-8186",
        "AZD-8330", "Abemaciclib", "Afatinib", "Afatinib_inBT474", "Alectinib",
        "Alisertib", "Alvocidib", "Amuvatinib", "Apatinib", "Apitolisib",
        "Axitinib", "BGT-226", "BI-2536", "BI-847325", "BMS-387032",
        "BMS-690514", "BMS-690514_inBT474", "BMS-754807", "BMS-777607",
        "BMS-777607_withCAKI", "BMS-911543", "BYL-719", "Bafetinib",
        "Barasertib", "Barasertib_HQPA", "Baricitinib"
    ]
    ...
    intensities = pd.read_csv('data/all_intensities_distribution.csv', header=None).values.flatten()
    ...
    for drug in drugs:
        ...
        results = analyze_drug(drug, most_freq_protein_df, intensities, most_frequent_protein, output_dir)
    ...
    if all_results:
        ...
        print(f"Drugs with significant differences: {final_results['Statistically_Significant'].value_counts()['Yes']}")
